...
public class UtilesSwing {
    ...
    public static boolean establecerLnF(String lnf) {
        ...
        // Instala LnF, si da fallo se quedará con el predeterminado, que es Metal.
        // "Pregunta" a la máquina virtual de JAva la lista de los LnF disponibles mediante el método getInstalledLookAndFeels(), después recorre la lista, 
        // y por cada uno de los disponibles coje el nombre, si el nombre del LnG actual coincide con el que le hemos pasado, lo establece y sigue recorriendo (poca eficiencia).
        // UIManager es la clase que festiona el aspecto visual de Swing. LookAndFeelInfo es una clase que está dentro de la clase UIManager.
        try {
    ...
    public static void establecerFavicon(JFrame ventana, String rutaFavicon) {
        try {
            // Ruta Favicon > URL Favicon. A partir de la ruta se crea un objeto de la clase URL, con la URL creo un objeto de la clase iconImage, 
            // y a partir del objeto iconImage se crea un objeto de la clase Image
            URL urlICN = ClassLoader.getSystemResource(rutaFavicon);

            // URL Favicon > Ventana Favicon. A partir del objeto image y gracias al método setIconImage() le asignamos el favicon a la ventana
